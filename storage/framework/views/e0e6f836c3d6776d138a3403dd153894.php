...
<div class="leyenda">
    ...
    <p>El indio semidesnudo se retorcía en su hamaca, presentaba grandes hematomas en las piernas y en la espalda. Colgada de un palo que servía de cerca se hallaba una larguísima, delgada y horrible víbora.
        ...
        <a href="<?php echo e(route('Fuete2')); ?>"><img id="flecha" src="<?php echo e(asset('local_storage/img/derecha.png')); ?>"  alt=""></a>
</div>
<div class="ojo">
    <img src="<?php echo e(asset('local_storage/img/ojo.gif')); ?>" >
</div>
...
<?php /**PATH C:\xampp\htdocs\proyectoFinal\resources\views\HistoriasPutumayo\HistoriaFueteadora.blade.php ENDPATH**/ ?>